...
A sleek and intuitive Flutter application designed to help users search for movies, view detailed information, and curate their personal watchlist. The app leverages the OMDb API to fetch movie details and provides a clean, modern UI with smooth animations to enhance user experience.
## 🚀 Features
### 🕵️‍♂️ Movie Search
